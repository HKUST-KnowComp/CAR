...
def main():
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    out_file = os.path.join(out_dir, '{}_predictions.jsonl'.format(args.reader))
    log_file = os.path.join(out_dir, '{}_results.txt'.format(args.reader))
